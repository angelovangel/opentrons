...
metadata = {'protocolName': 'QIASeq FX 48x v8','author': 'Opentrons <protocols@opentrons.com>','source': 'Protocol Library',}
...
def add_parameters(parameters):
    ...
    parameters.add_int(
        ...
        default=15,minimum=10,maximum=30,
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    AllSteps=[STEP_FXENZ,STEP_LIG,STEP_CLEANUP_1,STEP_CLEANUP_2,STEP_PCR,STEP_CLEANUP_3]
    if COLUMNS >= 4  and all(AllSteps) == True:
    ...
    if COLUMNS == 6:
        BATCHREP              = 2         # Do Final Cleanup in 2 batches of columns
    if COLUMNS < 6:
        BATCHREP              = 1         # Do Final Cleanup all at once
    ...
    if TIP_SETTING == 'Reusing Tips':
        ...
        REUSE_50_TIPS_RSB     = True      # Default False   | Reusing p50 tips
    ...
    if ONDECK_HEATERSHAKER == True:
        ...
        CleanupPlate_1 = heatershaker.load_labware('nest_96_wellplate_2ml_deep')
    else:
        CleanupPlate_1 = protocol.load_labware('nest_96_wellplate_2ml_deep', 'D1')
    ...
    if TRASH_POSITION == 'BIN':
        ...
        if COLUMNS >=5:
            CleanupPlate_2 = protocol.load_labware('nest_96_wellplate_2ml_deep', 'D4')
        else:
    ...
    if COLUMNS == 1:
        ...
        column_2_list = ['A1'] # Cleanup Plate 1: ETOH
        LIG_list = ['A2']
        ETOH_1_list = ['A4']
        ETOH_2_list = ['A5']
        ETOH_3_list = ['A6']
        column_3_list = ['A5'] # Cleanup Plate 1: ETOH
        column_4_list = ['A7'] # Sample Plate 1: EPM
        column_5_list = ['A9'] # Cleanup Plate 1: ETOH
        column_6_list = ['A9'] # Sample Plate 1: Final
        barcodes = ['A7']
    if COLUMNS == 2:
        column_1_list = ['A1','A2'] # Sample Plate 1: input and TAG
        column_2_list = ['A1','A2'] # Cleanup Plate 1: ETOH
        LIG_list = ['A2','A2']
        ETOH_1_list = ['A4','A4']
        ETOH_2_list = ['A5','A5']
        ETOH_3_list = ['A6','A6']
        column_3_list = ['A5','A6'] # Cleanup Plate 1: ETOH
        column_4_list = ['A7','A8'] # Sample Plate 1: EPM
        column_5_list = ['A9','A10'] # Cleanup Plate 1: ETOH
        column_6_list = ['A9','A10'] # Sample Plate 1: Final
        barcodes = ['A7','A8']
    if COLUMNS == 3:
        column_1_list = ['A1','A2','A3'] # Sample Plate 1: input and TAG
        column_2_list = ['A1','A2','A3'] # Cleanup Plate: ETOH
        LIG_list = ['A2','A2','A2']
        ETOH_1_list = ['A4','A4','A4']
        ETOH_2_list = ['A5','A5','A5']
        ETOH_3_list = ['A6','A6','A6']
        column_3_list = ['A5','A6','A7'] # Cleanup Plate: ETOH
        column_4_list = ['A5','A6','A7'] # Sample Plate 1: EPM
        column_5_list = ['A9','A10','A11'] # Cleanup Plate: ETOH
        column_6_list = ['A9','A10','A11'] # Sample Plate 1: Final
        barcodes = ['A7','A8','A9']
    if COLUMNS == 4:
        column_1_list = ['A1','A2','A3','A4'] # Sample Plate 1: input and TAG
        column_2_list = ['A1','A2','A3','A4'] # Cleanup Plate 1: ETOH
        LIG_list = ['A2','A2','A3','A3']
        ETOH_1_list = ['A4','A4','A4','A4']
        ETOH_2_list = ['A5','A5','A5','A5']
        ETOH_3_list = ['A6','A6','A6','A6']
        column_3_list = ['A5','A6','A7','A8'] # Cleanup Plate 1: ETOH
        column_4_list = ['A5','A6','A7','A8'] # Sample Plate 1: EPM
        column_5_list = ['A9','A10','A11','A12'] # Cleanup Plate 1: ETOH
    ...
    if COLUMNS == 5:
        ...
        column_2_list = ['A1','A2','A3','A4','A5'] # Cleanup Plate 1: ETOH
        LIG_list = ['A2','A2','A2','A3','A3']
        ETOH_1_list = ['A4','A4','A4','A4','A4']
        ETOH_2_list = ['A5','A5','A5','A5','A5']
        ETOH_3_list = ['A6','A6','A6','A6','A6']
        column_3_list = ['A7','A8','A9','A10','A11'] # Cleanup Plate 1: ETOH
        column_4_list = ['A7','A8','A9','A10','A11'] # Sample Plate 1: EPM
        column_5_list = ['A1','A2','A3','A4','A5'] # Cleanup Plate 2: ETOH
        column_6_list = ['A1','A2','A3','A4','A5'] # Sample Plate 2: Final
        barcodes = ['A7','A8','A9','A10','A11']
    if COLUMNS == 6:
        column_1_list = ['A1','A2','A3','A4','A5','A6'] # Sample Plate 1: input and TAG
        column_2_list = ['A1','A2','A3','A4','A5','A6'] # Cleanup Plate 1: ETOH
        LIG_list = ['A2','A2','A2','A3','A3','A3']
        ETOH_1_list = ['A4','A4','A4','A4','A4','A4']
        ETOH_2_list = ['A5','A5','A5','A5','A5','A5']
        ETOH_3_list = ['A6','A6','A6','A6','A6','A6']
        column_3_list = ['A7','A8','A9','A10','A11','A12'] # Cleanup Plate 1: ETOH
        column_4_list = ['A7','A8','A9','A10','A11','A12'] # Sample Plate 1: EPM
        column_5_list = ['A1','A2','A3','A4','A5','A6'] # Cleanup Plate 2: ETOH
    ...
    if STEP_FXENZ == True:
        ...
        for loop, X in enumerate(column_1_list):
            ...
            p50.mix(FXENZBuffPremix,FXENZBuffVol+1, FXENZ.bottom(z=PCRPlate_Z_offset+0.25))
            p50.aspirate(FXENZBuffVol+1, FXENZ.bottom(z=PCRPlate_Z_offset+0.25))
            p50.dispense(1, FXENZ.bottom(z=PCRPlate_Z_offset+0.25))
            p50.dispense(FXENZBuffVol, sample_plate_1.wells_by_name()[X].bottom(z=PCRPlate_Z_offset+0.25))
            p50.mix(FXENZVMixRep,FXENZVMixVol)
    ...
    if STEP_LIG == True:
        ...
        for loop, X in enumerate(column_1_list):
            ...
            p1000.mix(LIGMixPremix,LIGVol+2, reagent_plate_1.wells_by_name()[LIG_list[loop]].bottom(z=PCRPlate_Z_offset+0.25))
            p1000.aspirate(LIGVol+2, reagent_plate_1.wells_by_name()[LIG_list[loop]].bottom(z=PCRPlate_Z_offset+0.25))
            p1000.dispense(2, reagent_plate_1.wells_by_name()[LIG_list[loop]].bottom(z=PCRPlate_Z_offset+0.25))
            p1000.default_speed = 100
            p1000.move_to(reagent_plate_1.wells_by_name()[LIG_list[loop]].top(z=5))
        ...
        if ONDECK_THERMO == True:
            ...
            if DRYRUN == False:
                protocol.pause('Pausing to run Ligation on an off deck Thermocycler ~15min')
            else:
    ...
    if STEP_CLEANUP_1 == True:
        ...
        for loop, X in enumerate(column_1_list):
            ...
            p1000.default_speed = 400
            #================================                
            p1000.dispense(CleanupBeadVol, CleanupPlate_1[column_2_list[loop]].bottom(z=Deepwell_Z_offset+0.25))
            ...
            p1000.aspirate(TransferSup/2)
            p1000.dispense(TransferSup, CleanupPlate_1[column_2_list[loop]].bottom(z=Deepwell_Z_offset+1))
            #================================
            p1000.default_speed = 100
            p1000.move_to(CleanupPlate_1[column_2_list[loop]].bottom(z=Deepwell_Z_offset+3))
            if TIP_MIX == True:
                CleanupBeadMix = 10
            if TIP_MIX == False:
                CleanupBeadMix = 2
            for Mix in range(CleanupBeadMix):
                ...
                Mix += 1
            p1000.move_to(CleanupPlate_1[column_2_list[loop]].top(z=-3))
            protocol.delay(seconds=1)
            p1000.blow_out(CleanupPlate_1[column_2_list[loop]].top(z=-3))
            p1000.touch_tip(speed=100)
            p1000.default_speed = 400
            p1000.move_to(CleanupPlate_1[column_2_list[loop]].top(z=5))
            p1000.move_to(CleanupPlate_1[column_2_list[loop]].top(z=0))
            p1000.move_to(CleanupPlate_1[column_2_list[loop]].top(z=5))
            p1000.default_speed = 400
        ...
        for loop, X in enumerate(column_2_list):
            TipCheck(200,'REUSE',loop,'ETOH_1')
            p1000.move_to(CleanupPlate_1[X].bottom(z=Deepwell_Z_offset+2))
            p1000.aspirate(RemoveSup-100)
            protocol.delay(minutes=0.1)
            p1000.move_to(CleanupPlate_1[X].bottom(z=Deepwell_Z_offset+0))
            p1000.aspirate(100)
        ...
        for X in range(2):
            ...
            if ETOH_1_AirMultiDis == True:
                TipCheck(200,None,loop,None)
                for loop, X in enumerate(column_2_list):
                    p1000.aspirate(ETOHMaxVol, reservoir.wells_by_name()[ETOH_1_list[loop]].bottom(z=Deepwell_Z_offset+1), rate=0.5)
                ...
                for loop, X in enumerate(column_2_list):
                    ...
                    p1000.default_speed = 400
                    #================================       
                    p1000.dispense(ETOHMaxVol, CleanupPlate_1[X].top(z=-3), rate=0.5)
                    protocol.delay(seconds=2)
                    p1000.blow_out()
                    p1000.move_to(CleanupPlate_1[X].top(z=5))
                    p1000.move_to(CleanupPlate_1[X].top(z=0))
        ...
        for batch in range(BATCHREP):
            ...
            for loop, X in enumerate(column_2_list[batch*(int(len(column_2_list)/BATCHREP)):(1+batch)*int(len(column_2_list)/BATCHREP)]):
                TipCheck(200,'REUSE',loop,'ETOH_1')
                p1000.move_to(CleanupPlate_1[X].bottom(z=Deepwell_Z_offset+0.2))
                p1000.aspirate(200)
                TipDone(200,'REUSE',loop,'ETOH_1')
            #===============================================
            ...
            for loop, X in enumerate(column_2_list[batch*(int(len(column_2_list)/BATCHREP)):(1+batch)*int(len(column_2_list)/BATCHREP)]):
                ...
                p50.move_to(CleanupPlate_1.wells_by_name()[X].bottom(z=Deepwell_Z_offset+1))
                p50.dispense(RSBVol,CleanupPlate_1.wells_by_name()[X].bottom(z=Deepwell_Z_offset+1), rate=0.5)
                if TIP_MIX == True:
                    RSBMix = 10
                if TIP_MIX == False:
                    RSBMix = 2
                for Mix in range(RSBMix):
                    p50.aspirate(RSBVol, CleanupPlate_1.wells_by_name()[X].bottom(z=Deepwell_Z_offset+1), rate=0.5)
                    p50.dispense(RSBVol, CleanupPlate_1.wells_by_name()[X].bottom(z=Deepwell_Z_offset+1), rate=1)
        ...
        for loop, X in enumerate(column_2_list):
            TipCheck(50,'REUSE',loop,'RSB')
            p50.move_to(CleanupPlate_1[X].bottom(z=Deepwell_Z_offset+0.5))
            p50.aspirate(TransferSup/2)
            protocol.delay(seconds=1)
            p50.move_to(CleanupPlate_1[X].bottom(z=Deepwell_Z_offset+0.2))
            p50.aspirate(TransferSup/2)
            p50.dispense(TransferSup, CleanupPlate_1[column_3_list[loop]].bottom(z=Deepwell_Z_offset+1), rate=0.5)
            TipDone(50,'REUSE',loop,'RSB')
        #===============================================
    ...
    if STEP_CLEANUP_2 == True:
        ...
        for loop, X in enumerate(column_3_list):
            ...
            p1000.default_speed = 400
            #================================                
            p1000.dispense(CleanupBeadVol, CleanupPlate_1[X].bottom(z=Deepwell_Z_offset+0.25))
            p1000.default_speed = 100
            p1000.move_to(CleanupPlate_1[X].bottom(z=Deepwell_Z_offset+3))
            if TIP_MIX == True:
                CleanupBeadMix = 10
        ...
        #for loop, X in enumerate(column_3_list):
            ...
            if WASTEVOL >=28800:
                Liquid_trash = Liquid_trash_well_3
            #================================ 
            p1000.dispense(ActualRemoveSup, Liquid_trash.top(z=-3), rate=0.5)
            protocol.delay(seconds=1)
            p1000.blow_out()
            #=====Reservoir Tip Touch========
            p1000.default_speed = 100
        ...
        for X in range(2):
            ...
            if ETOH_1_AirMultiDis == True:
                TipCheck(200,None,loop,None)
                for loop, X in enumerate(column_3_list):
                    p1000.aspirate(ETOHMaxVol, reservoir.wells_by_name()[ETOH_2_list[loop]].bottom(z=Deepwell_Z_offset+1), rate=0.5)
        ...
        for batch in range(BATCHREP):
            ...
            p1000.flow_rate.blow_out = p1000_flow_rate_blow_out_default*0.5
            #===============================================
            for loop, X in enumerate(column_3_list[batch*(int(len(column_3_list)/BATCHREP)):(1+batch)*int(len(column_3_list)/BATCHREP)]):
                TipCheck(200,'REUSE',loop,'ETOH_1')
                p1000.move_to(CleanupPlate_1[X].bottom(0.2))
                p1000.aspirate(200)
                TipDone(200,'REUSE',loop,'ETOH_1')
            #===============================================
    ...
    if STEP_PCR == True:
        ...
        for loop, X in enumerate(column_3_list):
            TipCheck(50,None,loop,None)
            p50.aspirate(PrimerVol, Primer.bottom(z=0.5))
            p50.dispense(PrimerVol, sample_plate_1[column_2_list[loop]].bottom(z=1))
        ...
        for loop, X in enumerate(column_4_list):
            TipCheck(50,None,loop,None)
            p50.mix(PCRPremix,PCRVol, PCR.bottom(z=0.5))
            p50.aspirate(PCRVol, PCR.bottom(z=0.5))
            p50.dispense(PCRVol, sample_plate_1[X].bottom(z=1))
    ...
    if STEP_CLEANUP_3 == True:
        ...
        if COLUMNS >=5:
            #============================================================================================
            # GRIPPER MOVE (CleanupPlate_1) FROM MAG BLOCK --> TRASH
            if ONDECK_HEATERSHAKER == True:
                heatershaker.open_labware_latch()
                protocol.move_labware(labware=CleanupPlate_1,new_location=TRASH,use_gripper=USE_GRIPPER,pick_up_offset=mb_pick_up_offset,drop_offset=hs_drop_offset)
                heatershaker.close_labware_latch()
            else:
                protocol.move_labware(labware=CleanupPlate_1,new_location=TRASH,use_gripper=USE_GRIPPER,pick_up_offset=mb_pick_up_offset,drop_offset=deck_drop_offset)
            #============================================================================================
            #============================================================================================
            # GRIPPER MOVE (CleanupPlate_2) FROM OFFDECK --> HEATERSHAKER
            if ONDECK_HEATERSHAKER == True:
                heatershaker.open_labware_latch()
                ...
                protocol.move_labware(labware=CleanupPlate_2,new_location='D1',use_gripper=USE_GRIPPER,pick_up_offset=deck_pick_up_offset,drop_offset=deck_drop_offset)
            #============================================================================================
        else:
        ...
        for loop, X in enumerate(column_5_list):
            TipCheck(200,'REUSE',loop+COLUMNS,'ETOH_1')
            ...
            p1000.default_speed = 400
            #================================                
            p1000.dispense(CleanupBeadVol, CleanupPlate_2[X].bottom(z=0.25))
            protocol.comment('--> Transferring Samples')
            #================================                
            ...
            p1000.aspirate(TransferSup/2)
            p1000.dispense(TransferSup, CleanupPlate_2[X].bottom(z=1))
            #================================    
            p1000.default_speed = 100
            p1000.move_to(CleanupPlate_2[X].bottom(z=3))
            if TIP_MIX == True:
                CleanupBeadMix = 10
            if TIP_MIX == False:
                CleanupBeadMix = 2
            ...
            protocol.delay(seconds=1)
            p1000.blow_out(CleanupPlate_2[X].top(z=-3))
            p1000.touch_tip(speed=100)
            p1000.default_speed = 400
            p1000.move_to(CleanupPlate_2[X].top(z=5))
            p1000.move_to(CleanupPlate_2[X].top(z=0))
            p1000.move_to(CleanupPlate_2[X].top(z=5))
            TipDone(200,'REUSE',loop+COLUMNS,'ETOH_1')
        #===============================================
        if TIP_MIX == False:
            heatershaker.set_and_wait_for_shake_speed(rpm=CleanupBeadMixRPM)
            protocol.delay(CleanupBeadMixTime)
        ...
        for loop, X in enumerate(column_5_list):
            ...
            p1000.aspirate(RemoveSup-100)
            protocol.delay(seconds=3)
            p1000.move_to(CleanupPlate_2[X].bottom(z=0.5))
            p1000.aspirate(100)
            p1000.default_speed = 100
        ...
        for X in range(2):
            ...
            if ETOH_1_AirMultiDis == True:
                TipCheck(200,None,loop,None)
                for loop, X in enumerate(column_5_list):
                    p1000.aspirate(ETOHMaxVol, reservoir.wells_by_name()[ETOH_3_list[loop]].bottom(z=1), rate=0.5)
                    p1000.move_to(reservoir.wells_by_name()[ETOH_3_list[loop]].top(z=0))
                    p1000.move_to(reservoir.wells_by_name()[ETOH_3_list[loop]].top(z=-5))    
                    #=====Reservoir Tip Touch========
                    p1000.default_speed = 100
                    p1000.move_to(reservoir.wells_by_name()[ETOH_3_list[loop]].top().move(types.Point(x=4,z=-3)))
                    p1000.move_to(reservoir.wells_by_name()[ETOH_3_list[loop]].top().move(types.Point(x=-4,z=-3)))
                    p1000.default_speed = 400
                    #================================
                    p1000.move_to(CleanupPlate_2[X].top(z=2))
                    p1000.dispense(ETOHMaxVol, rate=0.75)
                    protocol.delay(seconds=2)
                    p1000.blow_out(CleanupPlate_2[X].top(z=0))
                    p1000.move_to(CleanupPlate_2[X].top(z=5))
                    p1000.move_to(CleanupPlate_2[X].top(z=0))
                    p1000.move_to(CleanupPlate_2[X].top(z=5))
                TipDone(200,None,loop,None)
                ...
                for loop, X in enumerate(column_5_list):
                    ...
                    p1000.default_speed = 400
                    #================================       
                    p1000.dispense(ETOHMaxVol, CleanupPlate_2[X].top(z=-3), rate=0.5)
                    protocol.delay(seconds=2)
                    p1000.blow_out()
                    p1000.move_to(CleanupPlate_2[X].top(z=5))
                    p1000.move_to(CleanupPlate_2[X].top(z=0))
            ...
            for loop, X in enumerate(column_5_list):
                ...
                p1000.aspirate(RemoveSup-100)
                protocol.delay(seconds=3)
                p1000.move_to(CleanupPlate_2[X].bottom(z=0.75))
                p1000.aspirate(100)
                p1000.default_speed = 100
                p1000.move_to(CleanupPlate_2[X].top(z=-2))
                p1000.default_speed = 200
        ...
        for batch in range(BATCHREP):
            ...
            p1000.flow_rate.blow_out = p1000_flow_rate_blow_out_default*0.5
            #===============================================
            for loop, X in enumerate(column_5_list[batch*(int(len(column_5_list)/BATCHREP)):(1+batch)*int(len(column_5_list)/BATCHREP)]):
                TipCheck(200,'REUSE',loop+COLUMNS,'ETOH_1')
                p1000.move_to(CleanupPlate_2[X].bottom(0.2))
                p1000.aspirate(50)
                TipDone(200,'REUSE',loop+COLUMNS,'ETOH_1')
            #===============================================
            ...
            if ONDECK_HEATERSHAKER == True:
                ...
                protocol.move_labware(labware=CleanupPlate_2,new_location='D1', use_gripper=USE_GRIPPER,pick_up_offset=mb_pick_up_offset,drop_offset=deck_drop_offset)
            #============================================================================================
            ...
            #===============================================
            for loop, X in enumerate(column_5_list[batch*(int(len(column_5_list)/BATCHREP)):(1+batch)*int(len(column_5_list)/BATCHREP)]):
                TipCheck(50,'REUSE',loop+COLUMNS,'RSB')
                p50.aspirate(RSBVol+2, RSB.bottom(z=1))
                p50.dispense(2, RSB.bottom(z=1))
                p50.move_to(CleanupPlate_2.wells_by_name()[X].bottom(z=1))
                p50.dispense(RSBVol,CleanupPlate_2.wells_by_name()[X].bottom(z=1), rate=0.5)
                if TIP_MIX == True:
                    CleanupBeadMix = 10
                if TIP_MIX == False:
                    CleanupBeadMix = 2
                ...
                TipDone(50,'REUSE',loop+COLUMNS,'RSB')
            #===============================================
            if TIP_MIX == False:
                heatershaker.set_and_wait_for_shake_speed(rpm=RSBMixRPM)
                protocol.delay(RSBMixTime)
        ...
        if COLUMNS >= 5:
            #============================================================================================
            # GRIPPER MOVE (sample_plate_2) FROM OFF DECK --> HEATERSHAKER
            if ONDECK_HEATERSHAKER == True:
                heatershaker.open_labware_latch()
        ...
        for loop, X in enumerate(column_5_list):
            TipCheck(50,'REUSE',loop+COLUMNS,'RSB')
            p50.move_to(CleanupPlate_2[X].bottom(z=0.5))
            p50.aspirate(TransferSup/2)
            protocol.delay(seconds=1)
            p50.move_to(CleanupPlate_2[X].bottom(z=0.2))
            p50.aspirate(TransferSup/2)
            if COLUMNS >= 5:
                p50.dispense(TransferSup, sample_plate_2[column_6_list[loop]].bottom(z=1), rate=0.5)
            else:    
                p50.dispense(TransferSup, sample_plate_1[column_6_list[loop]].bottom(z=1), rate=0.5)
            TipDone(50,'REUSE',loop+COLUMNS,'RSB')
        #===============================================
    ...
    if NOLABEL == False:
       # PROTOCOL SETUP - LABELING
        ...
        # ======== ESTIMATING LIQUIDS =======
        Sample_Volume = 40
        CleanupBead_Volume = COLUMNS*(180)
        ETOH_Volume = COLUMNS*(900)
        RSB_Volume = COLUMNS*(98)
        FXENZ_Volume = COLUMNS*(15)
        LIG_Volume = COLUMNS*(45)
        Primer_Volume = COLUMNS*(5)
        ...
        if RES_TYPE_96x == False:
            ...
            reservoir.wells_by_name()['A4'].load_liquid(liquid=EtOH, volume=(ETOH_Volume/3))
            reservoir.wells_by_name()['A5'].load_liquid(liquid=EtOH, volume=(ETOH_Volume/3))
            reservoir.wells_by_name()['A6'].load_liquid(liquid=EtOH, volume=(ETOH_Volume/3))
        ...
        if RES_TYPE_96x == True:
            for loop, X in enumerate(TotalColumn):
                ...
                reservoir.wells_by_name()[X+'4'].load_liquid(liquid=EtOH, volume=(ETOH_Volume/3))
                reservoir.wells_by_name()[X+'5'].load_liquid(liquid=EtOH, volume=(ETOH_Volume/3))
                reservoir.wells_by_name()[X+'6'].load_liquid(liquid=EtOH, volume=(ETOH_Volume/3))
        ...
        for loop, X in enumerate(TotalColumn):
            ...
            if COLUMNS == 6:
                reagent_plate_1.wells_by_name()[X+'2'].load_liquid(liquid=LIG, volume=(LIG_Volume/2))
                reagent_plate_1.wells_by_name()[X+'3'].load_liquid(liquid=LIG, volume=(LIG_Volume/2))
